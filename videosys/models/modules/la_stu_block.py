...
class BasicTransformerBlock(nn.Module):
    ...
    def __init__(
        ...
        if positional_embeddings == "sinusoidal":
            raise NotImplementedError("Sinusoidal positional embeddings are not implemented yet.")
        ...
        if attention_type == "gated" or attention_type == "gated-text-image":
            raise NotImplementedError("Attention type gated-text-image is not implemented yet.")
    ...
    def forward(
        ...
        attn_cache: Optional[Tuple[QKVCache]] = (None, None),
...
class BasicTransformerBlock_(nn.Module):
    ...
    def forward(
        ...
        cross_attention_kwargs: Dict[str, Any] = None,
        class_labels: Optional[torch.LongTensor] = None,
        attn_cache: Optional[QKVCache] = None,
        token_index: Optional[torch.Tensor] = None,
        sub_batch_size: Optional[int] = None,
        context_length: Optional[int] = None,
    ) -> torch.FloatTensor:
