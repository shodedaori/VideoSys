...
from videosys.schedulers.scheduling_ddim_stu import DDIMSchedulerSTU
...
from videosys.models.transformers.latte_stu_model import LatteT2V, LatteSTU
...
class LatteSTUConfig:
    ...
    def __init__(
        ...
        # ====== stu ========
        self.stu_coef = stu_coef
        self.stu_filter = stu_filter
...
class LattePipeline(VideoSysPipeline):
    ...
    def __init__(
        ...
        scheduler: Optional[DDIMSchedulerSTU] = None,
        ...
        if scheduler is None:
            scheduler = DDIMSchedulerSTU.from_pretrained(
                config.model_path,
                subfolder="scheduler",
    ...
    def generate(
        ...
        print(f"Total steps: {num_inference_steps}, Warm steps: {warm_steps}, First stage end: {first_stage_end}")
